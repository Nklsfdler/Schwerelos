export default function AGB() {
    return (
        <div className="min-h-screen bg-black text-white p-8 md:p-24 font-[family-name:var(--font-dm)]">
            <h1 className="text-4xl font-[family-name:var(--font-outfit)] font-bold mb-8 text-blue-200">Allgemeine Geschäftsbedingungen</h1>
            <div className="max-w-3xl space-y-6 text-white/70">
                <p><strong>1. Geltungsbereich</strong><br />Für alle Geschäftsbeziehungen zwischen uns (Schwerelos GmbH) und dem Besteller gelten ausschließlich die nachfolgenden Allgemeinen Geschäftsbedingungen in ihrer zum Zeitpunkt der Bestellung gültigen Fassung.</p>
                <p><strong>2. Vertragspartner</strong><br />Der Kaufvertrag kommt zustande mit der Schwerelos GmbH, Musterstraße 1, 85049 Ingolstadt.</p>
