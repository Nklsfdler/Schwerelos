...
export const TouchIcon = () => (
    <div className="absolute z-20 flex items-center justify-center opacity-80 group-hover:opacity-0 transition-opacity duration-500 pointer-events-none bottom-6 right-6">
